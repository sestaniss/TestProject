...
public class RecapTask4 {
    public static void main(String[] args) {
        /*
        1) Write a program to ask a user to enter item they want to buy and the price of that item.
        User will be entering multiple items every time user enters price accumulate the price
        and tell the user how much total that they should pay
        2) Every time user enters price accumulate the amount and tell the user how much total they should pay.
        3) If user give more money program should return a change.
        4) Whenever a user done with payments program should say "Thank you for shopping!"
         */
        /*
